...
create_window_main (void)
{
  ...
  gtk_widget_set_size_request (next, 140, 28);
  GTK_WIDGET_UNSET_FLAGS (next, GTK_CAN_FOCUS);

  prev = gtk_button_new_from_stock ("gtk-go-back");
  gtk_widget_show (prev);
  gtk_fixed_put (GTK_FIXED (fixed1), prev, 381, 488);
  gtk_widget_set_size_request (prev, 140, 28);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), exit, 10, 488);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), scrolledwindow1, 169, 192);
  gtk_widget_set_size_request (scrolledwindow1, 505, 184);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), checkbutton_mountpoints, 169, 136);
  gtk_widget_set_size_request (checkbutton_mountpoints, 505, 48);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton_mountpoints), TRUE);

  hseparator1 = gtk_hseparator_new ();
  gtk_widget_show (hseparator1);
  gtk_fixed_put (GTK_FIXED (fixed3), hseparator1, 169, 126);
  gtk_widget_set_size_request (hseparator1, 505, 16);

  checkbutton_format_with = gtk_check_button_new_with_mnemonic (_("format with"));
  gtk_widget_show (checkbutton_format_with);
  gtk_fixed_put (GTK_FIXED (fixed3), checkbutton_format_with, 169, 64);
  gtk_widget_set_size_request (checkbutton_format_with, 174, 28);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (checkbutton_format_with), TRUE);

  label7 = gtk_label_new (_("Root-Partition"));
  gtk_widget_show (label7);
  gtk_fixed_put (GTK_FIXED (fixed3), label7, 169, 24);
  gtk_widget_set_size_request (label7, 175, 28);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), checkbutton_automount, 169, 96);
  gtk_widget_set_size_request (checkbutton_automount, 520, 32);
  ...
  gtk_fixed_put (GTK_FIXED (fixed3), label8, 16, 215);
  gtk_widget_set_size_request (label8, 144, 60);
  ...
  label43 = gtk_label_new (_("<big> Language </big>"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), label14, 96, 130);
  gtk_widget_set_size_request (label14, 256, 42);
  ...
  gtk_fixed_put (GTK_FIXED (fixed5), frame1, 88, 120);
  gtk_widget_set_size_request (frame1, 500, 240);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), entry_rootpw, 250, 0);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), entry_rootpw_again, 250, 32);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), entry_realname, 250, 88);
  gtk_widget_set_size_request (entry_realname, 216, 24);

  entry_username = gtk_entry_new ();
  gtk_widget_show (entry_username);
  gtk_fixed_put (GTK_FIXED (fixed8), entry_username, 250, 120);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), entry_pw, 250, 160);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), entry_pw_again, 250, 192);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), image_root_pw, 470, 0);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), image_username, 470, 122);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), image_pw, 470, 162);
  ...
  gtk_fixed_put (GTK_FIXED (fixed8), image_pw_again, 470, 194);
  ...
  gtk_widget_set_size_request (label61, 250, 24);
  ...
  gtk_container_set_border_width (GTK_CONTAINER (fixed19), 15);

  scrolledwindow4 = gtk_scrolled_window_new (NULL, NULL);
  gtk_widget_show (scrolledwindow4);
  gtk_fixed_put (GTK_FIXED (fixed19), scrolledwindow4, 16, 0);
  gtk_widget_set_size_request (scrolledwindow4, 633, 305);
  ...
  gtk_viewport_set_shadow_type (GTK_VIEWPORT (viewport4), GTK_SHADOW_ETCHED_IN);

  fixed20 = gtk_fixed_new ();
  gtk_widget_show (fixed20);
  gtk_container_add (GTK_CONTAINER (viewport4), fixed20);

  label_firmware = gtk_label_new_with_mnemonic ("");
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), button_install, 185, 320);
  gtk_widget_set_size_request (button_install, 274, 36);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), hseparator26, 96, 240);
  gtk_widget_set_size_request (hseparator26, 472, 16);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), vseparator10, 88, 248);
  gtk_widget_set_size_request (vseparator10, 16, 48);

  vseparator11 = gtk_vseparator_new ();
  gtk_widget_show (vseparator11);
  gtk_fixed_put (GTK_FIXED (fixed7), vseparator11, 560, 248);
  gtk_widget_set_size_request (vseparator11, 16, 48);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), hseparator17, 96, 200);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), checkbutton_force, 112, 144);
  gtk_widget_set_size_request (checkbutton_force, 400, 56);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), label37, 135, 256);
  gtk_widget_set_size_request (label37, 158, 32);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), label_rootpart_warning, 299, 256);
  ...
  GLADE_HOOKUP_OBJECT (window_main, fixed19, "fixed19");
  GLADE_HOOKUP_OBJECT (window_main, scrolledwindow4, "scrolledwindow4");
  ...
  GLADE_HOOKUP_OBJECT (window_main, hseparator26, "hseparator26");
  GLADE_HOOKUP_OBJECT (window_main, hseparator16, "hseparator16");
  GLADE_HOOKUP_OBJECT (window_main, vseparator10, "vseparator10");
  GLADE_HOOKUP_OBJECT (window_main, vseparator11, "vseparator11");
...
create_dialog_end (void)
{
  ...
  label41 = gtk_label_new (_("<big><b>Installation successful</b></big>"));
...
create_dialog_keyb_change (void)
{
  ...
  label44 = gtk_label_new (_("<span foreground=\"red\" font_desc=\"Sans Bold 10\">The keyboardlayout of the installed system does not match the current layout.\n\nYou might have problems typing your password!</span>"));
...
create_install_window (void)
{
  ...
  gtk_container_set_border_width (GTK_CONTAINER (fixed17), 10);

  hseparator22 = gtk_hseparator_new ();
  gtk_widget_show (hseparator22);
  gtk_fixed_put (GTK_FIXED (fixed17), hseparator22, 8, 168);
  gtk_widget_set_size_request (hseparator22, 398, 16);

  hseparator25 = gtk_hseparator_new ();
  gtk_widget_show (hseparator25);
  gtk_fixed_put (GTK_FIXED (fixed17), hseparator25, 8, 56);
  gtk_widget_set_size_request (hseparator25, 398, 16);

  image24 = create_pixmap (install_window, "install-gui-title.png");
  gtk_widget_show (image24);
  gtk_fixed_put (GTK_FIXED (fixed17), image24, 232, 0);
  gtk_widget_set_size_request (image24, 172, 54);

  button_install_now_back = gtk_button_new_from_stock ("gtk-go-back");
  gtk_widget_show (button_install_now_back);
  gtk_fixed_put (GTK_FIXED (fixed17), button_install_now_back, 224, 192);
  gtk_widget_set_size_request (button_install_now_back, 140, 28);
  ...
  gtk_widget_set_size_request (button1, 140, 28);
  ...
  gtk_fixed_put (GTK_FIXED (fixed17), button_edit_configuration, 376, 192);
  gtk_widget_set_size_request (button_edit_configuration, 28, 28);
  gtk_tooltips_set_tip (tooltips, button_edit_configuration, _("EDIT CONFIGURATION FILE\n---------------------------------\nNot necessary, be careful !!!"), NULL);
...
GtkWidget*
create_dialog_no_bash (void)
{
  GtkWidget *dialog_no_bash;
  GdkPixbuf *dialog_no_bash_icon_pixbuf;
  GtkWidget *vbox1;
  GtkWidget *fixed18;
  GtkWidget *label55;
  GtkWidget *image23;
  ...
  if (dialog_no_bash_icon_pixbuf)
    {
      ...
      gdk_pixbuf_unref (dialog_no_bash_icon_pixbuf);
    }
  gtk_window_set_type_hint (GTK_WINDOW (dialog_no_bash), GDK_WINDOW_TYPE_HINT_DIALOG);
  gtk_window_set_gravity (GTK_WINDOW (dialog_no_bash), GDK_GRAVITY_CENTER);

  vbox1 = GTK_DIALOG (dialog_no_bash)->vbox;
  ...
  gtk_fixed_put (GTK_FIXED (fixed18), label55, 8, 270);
  gtk_widget_set_size_request (label55, 496, 22);
  ...
  gtk_misc_set_alignment (GTK_MISC (label53), 0.5, 0.03);

  label56 = gtk_label_new (_("<span foreground=\"red\" font_desc=\"14\">getenv FLL_FIRMWARE isn't defined.\nPlease start with \"install-gui.bash\"\n</span>"));
  gtk_widget_show (label56);
  gtk_fixed_put (GTK_FIXED (fixed18), label56, 0, 216);
  gtk_widget_set_size_request (label56, 504, 56);
  gtk_label_set_use_markup (GTK_LABEL (label56), TRUE);
  gtk_label_set_justify (GTK_LABEL (label56), GTK_JUSTIFY_CENTER);
  gtk_misc_set_alignment (GTK_MISC (label56), 0.5, 0);

  hbuttonbox1 = GTK_DIALOG (dialog_no_bash)->action_area;
  gtk_widget_show (hbuttonbox1);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (hbuttonbox1), GTK_BUTTONBOX_END);

  button2 = gtk_button_new_with_mnemonic (_("OK"));
  gtk_widget_show (button2);
  gtk_dialog_add_action_widget (GTK_DIALOG (dialog_no_bash), button2, GTK_RESPONSE_OK);
  GTK_WIDGET_SET_FLAGS (button2, GTK_CAN_DEFAULT);

  g_signal_connect ((gpointer) dialog_no_bash, "delete_event",
                    G_CALLBACK (on_dialog_end_delete_event),
                    NULL);
  ...
  /* Store pointers to all widgets, for use by lookup_widget(). */
  GLADE_HOOKUP_OBJECT_NO_REF (dialog_no_bash, dialog_no_bash, "dialog_no_bash");
  GLADE_HOOKUP_OBJECT_NO_REF (dialog_no_bash, vbox1, "vbox1");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, fixed18, "fixed18");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, label55, "label55");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, image23, "image23");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, label53, "label53");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, label56, "label56");
  GLADE_HOOKUP_OBJECT_NO_REF (dialog_no_bash, hbuttonbox1, "hbuttonbox1");
  GLADE_HOOKUP_OBJECT (dialog_no_bash, button2, "button2");

  return dialog_no_bash;
}
